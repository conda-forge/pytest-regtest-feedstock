...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-regtest-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2572&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-regtest-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-regtest` can be installed with:

```
conda install pytest-regtest
```

It is possible to list all of the versions of `pytest-regtest` available on your platform with:
